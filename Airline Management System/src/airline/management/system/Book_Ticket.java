...
public class Book_Ticket extends JFrame{ //Third Frame
...
//            add(textField_1);
            ...
            Address.setBounds(60, 270, 150, 27);
            add(Address);
            ...
            Next.addActionListener(new ActionListener(){
                public void actionPerformed(ActionEvent ae){
                    ...
                    try {
                        conn c = new conn();
                        String str = "INSERT INTO passenger values( '"+address+"', '"+nationality+"','"+name+"', '"+gender+"', '"+ph_no+"','"+passport_No+"', '"+fl_code+"')";
