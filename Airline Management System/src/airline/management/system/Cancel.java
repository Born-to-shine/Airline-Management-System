...
//	add(Ticketid);
	...
	Flightcode.setBounds(60, 150, 150, 27);
	add(Flightcode);
	...
	Cancel.setBounds(250, 200, 150, 30);
	add(Cancel);
...
//	add(textField_4);
		...
		String flight_code = textField_1.getText();
...
//		String flight_code = textField_4.getText();
		...
		try{	
                    conn c = new conn();
                    String str = "INSERT INTO cancellation(passport_no, fli_code) values('"+passport_no+"','"+flight_code+"')";
                    String str1 = "delete from passenger where passport_no='"+passport_no+"' and fl_code='"+flight_code+"';";
